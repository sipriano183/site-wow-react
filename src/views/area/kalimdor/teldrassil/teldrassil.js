...
import map from "../../../../assets/images/Miscellaneous/Map02.png";
    ...
    <div className="introduction">
      ...
      {isShow && 
        <div className="main_text">
          ...
          <h3>Map and Geography</h3>
          <button className="show_content" title="Open Map" onClick={toggleMap}>
            <img src={map} className="map_icon" alt="Map Icon" />
          </button>
          {isShowMap && (
            <img
              src={teldrassil_map}
          ...
          <ul>
            <li>
              {" "}
              - Shadowglen: Where new Night Elves are trained. Aldrassil is here
              and it houses vendors and trainers for the classes available to
              the Elves.
            </li>
            <li>
              {" "}
